...
export async function generateMetadata(props) {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      images: [{ url: achievement.ogImage, width: 1200, height: 630, alt: achievement.name }],
    },
    twitter: {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ margin: "6px 0 4px", fontSize: 40, fontWeight: 800, color: "#fff" }}>
          {achievement.name}
        </h1>

        <p style={{ margin: "0 0 4px", fontSize: 20, color: "#CBD5E1" }}>
          Awarded to <strong style={{ color: "#fff" }}>{cred.recipient_name}</strong>
        </p>
        <p style={{ margin: "0 0 20px", fontSize: 15, color: "#94A3B8" }}>
          <span aria-hidden="true" style={{ color: "#22C55E", marginRight: 6 }}>✓</span>
        ...
        >
          <a href={addUrl} target="_blank" rel="noopener noreferrer" style={btnPrimary}>
            Add to LinkedIn profile
          </a>
          <a href={shareUrl} target="_blank" rel="noopener noreferrer" style={btnSecondary}>
            Share
          </a>
        ...
        >
          <span>
            Credential ID:{" "}
            <code style={{ color: "#CBD5E1" }}>{cred.id}</code>
          </span>
          <a href={achievement.criteriaUrl} style={{ color: "#818CF8", textDecoration: "none" }}>
      ...
      <a
        ...
        style={{ marginTop: 24, fontSize: 13, color: "#818CF8", textDecoration: "none" }}
      >
