...
Faable Deploy builds and runs a GitHub repository as a public HTTPS service with no Dockerfile and no CI configuration. Common workloads: REST and JSON APIs in Python (Flask, FastAPI, Django) and Node.js (Express, NestJS); webhook endpoints (Stripe and the like) and WhatsApp, Telegram, Discord and Slack bots, all driven by inbound HTTP, in Node.js or Python; and web apps in Next.js, Vite and static frameworks. Supported runtimes: Node.js 20, 22, 24 and Python 3.11, 3.12.
`
