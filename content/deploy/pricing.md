...
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Free**  | 1 free `bi.xs` instance per project · catalog limited to `bi.xs` · **managed Node and Python buildpacks only** · **up to 10 successful deployments per day per project** (resets at 00:00 UTC) · **build artifacts up to 512 MB** · 10 GB bandwidth |
...
On the **Free** plan, apps build with the two managed buildpacks:
