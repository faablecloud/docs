...
description: What each Faable plan includes for Faable Deploy — Docker and Dockerfile builds need Hobby or Pro, plus the instance catalog, deployments per day, artifact size limits and the egress allowance of each tier.
rank: high
---
