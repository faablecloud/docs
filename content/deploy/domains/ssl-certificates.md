...
description: Secure your custom domains with SSL certificates. Learn about managed SSL and how to upload custom enterprise certificates to Faable.
---
...
Custom SSL certifiacates can be uploaded via the [domains](https://dashboard.faable.com/domains) configuration page on [Faable Dashboard](https://dashboard.faable.com).
