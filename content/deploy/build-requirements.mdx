...
description: How Faable's remote builder detects and builds your project — package.json for Node.js, requirements.txt or pyproject.toml for Python, Dockerfile as escape hatch — plus monorepo Root Directory, the $PORT contract and faable.json options.
---
...
| `buildpack`           | Force a buildpack (`node`, `python`, `docker`) instead of auto-detection.                                                                                                                            |
