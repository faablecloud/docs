...
description: Frequently asked questions about Faable — what it is, European hosting and GDPR data residency, per-plan pricing and the free tier, supported frameworks, the built-in WAF, MAU allowances in Faable Auth, and how Faable Deploy and Faable Auth are bundled.
schema: faq
---
