...
✅ _Checkpoint:_ you can name, for your tenant, the account domain, one client, and one
connection.
...
✅ _Checkpoint:_ you complete a full login and have a `session` with an `id_token` and
an `access_token`.
...
✅ _Checkpoint:_ you can point at the claim that identifies the user (`sub` in the ID
...
✅ _Checkpoint:_ a `client_credentials`-authenticated backend lists your tenant's users
