...
3. **Enable at least one connection** on the client — email + password, passwordless, Google, GitHub… See [Connections](../connections.md). What the user sees on the [login screen](../hosted-login.mdx) is decided by your tenant's [Login Flow](../login-flows.md).
