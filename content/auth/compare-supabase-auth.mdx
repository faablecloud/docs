...
description: How Faable Auth compares to Supabase Auth. Faable Auth is a standalone, multi-tenant OAuth 2.0 / OIDC identity server hosted 100% in Europe under GDPR, with M2M tokens — not coupled to a single database.
---
...
| Enterprise SSO / SAML                    | ❌ not yet                          | ✅ (Pro/Team tiers)            |
...
- **You're building multi-tenant B2B SaaS** and want [multi-tenancy](what-is-a-multi-tenant-identity-server.mdx) and [M2M tokens](clients.md) without extra plumbing.
