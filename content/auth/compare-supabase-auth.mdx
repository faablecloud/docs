...
Faable Auth runs on **our own hardware in a European datacenter**, operated by a European company. We don't hold SOC 2, which Supabase does (report on Team and up). See [Security and Compliance](../platform/security-compliance.md).
