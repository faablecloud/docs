...
The surprising part: **your application contains no WebAuthn code.** The ceremony runs on Faable Auth's [hosted screen](../hosted-login.mdx#passkey-offer), and there is a good reason it has to — explained below.
...
- A tenant on the **Pro** plan to turn on passkeys as a sign-in method in step 1. The two-step verification policy at the end is available from **Hobby** up.
