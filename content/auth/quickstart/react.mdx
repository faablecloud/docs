...
- `signInWithOauthConnection({})` sends the user to your tenant's [Universal Login](../hosted-login.mdx) with every connection you've enabled. Target one directly with `{ connection_id: "connection_..." }`.
