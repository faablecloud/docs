...
> [!NOTE]
> Passwordless is available on **every plan, including Free**. On **Hobby** and **Pro** it is unlimited within your MAU allowance; **Free** runs on a fair-use allowance while you build. See [Auth pricing](pricing.md).
