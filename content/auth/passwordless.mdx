...
description: Empower your users with passwordless authentication. Learn how to implement Magic Links and One-Time Passwords (OTP) for a frictionless login experience.
---
