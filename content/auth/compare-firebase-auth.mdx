...
description: How Faable Auth compares to Firebase Authentication. Faable Auth is a standards-based, multi-tenant OAuth 2.0 / OIDC identity server hosted 100% in Europe under GDPR — without Google ecosystem lock-in — with first-class M2M tokens.
---
...
| Enterprise SSO / SAML                    | ❌ not yet                          | ✅ (Identity Platform tier)       |
...
- **You're building B2B or multi-tenant SaaS** and want [multi-tenancy](what-is-a-multi-tenant-identity-server.mdx) and [M2M tokens](clients.md) as first-class features.
