...
| Machine-to-machine tokens                | ✅ [client credentials](oauth-flows/client-credentials.mdx), 100/month free, then €2.25 per 1,000 | ❌ service accounts and the Admin SDK instead                                 |
