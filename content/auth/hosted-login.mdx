...
`/flow/login` — after **Send me a code**, the same screen asks for the 6-digit code emailed to the user. The code lasts 5 minutes; the user can ask for another once the countdown ends, or go back and use another address. See [Passwordless](passwordless.mdx#what-the-user-sees) for the email itself.
