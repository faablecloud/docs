...
Tenants are isolated by host, so orgs, teams, and users stay separate without extra plumbing. On top of this you get social login, passwordless, machine-to-machine tokens, [Actions](extensibility/actions.md), and [Webhooks](extensibility/webhooks.md) — all hosted 100% in Europe under GDPR.
