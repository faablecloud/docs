...
The model is **hybrid**: a monthly **platform fee** that unlocks features and entitlements, plus **usage** for the resources you consume (compute instances, MAU above the included allowance, and — on Pro only — egress above the plan's monthly allowance). Each month you receive the bill for the **previous** month's usage.

**Egress is never metered on Free or Hobby.** Each of those tiers includes a fixed monthly allowance (10 GB and 50 GB); Pro includes 100 GB and meters traffic beyond it. See [Deploy pricing](../deploy/pricing.md#bandwidth).
...
| **Hobby** | 15 € + usage | Production-ready for a single product. Full instance catalog, unlimited deployments, build artifacts up to 2 GB, 50 GB egress / month, custom domains, email support.         |
| **Pro**   | 99 € + usage | Multiple auth accounts, 10,000 MAU pooled, 100 GB egress / month plus metered traffic beyond it, audit logs, 99.9 % uptime SLA.                                               |
